...
assert.match(indexSource, /app-provider-workflow-v70/, "Die Anbieter-Statuslogik wird ohne Browser-Cache geladen.");
assert.match(indexSource, /styles-provider-workflow-v69/, "Die Anbieter-Statusleiste wird ohne Browser-Cache gestaltet.");
assert.match(
  indexSource,
